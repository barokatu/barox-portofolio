import logo from '../assets/brxlogo_white.png';
...
export default function Navbar() {
    ...
    <div className='fixed z-50 bg-dark-500 w-full top-0 left-0 px-8 py-4 lg:px-20 xl:px-36'>
        <div className="flex justify-between items-center text-white">
            ...
            <li className="p-4"><a href="#honors" className="hover:underline">Work Experiences</a></li>
            <li className="p-4"><a href="#certs" className="hover:underline">Projects Portofolio</a></li>
            </ul>
